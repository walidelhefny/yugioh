...
public class BoardWindow extends JFrame {
	...
	public BoardWindow () {
		...
		setContentPane(new JLabel(new ImageIcon("images/Pyramids.jpg")));
		...
		description.add(new JButton (new ImageIcon("images/Card Back.png")));
		add(description);
		...
		endPhase = new JButton(new ImageIcon("images/EndPhase.png"));
		endPhase.setOpaque(false);
		endPhase.setContentAreaFilled(false);
		endPhase.setBorderPainted(false);
		phase.add(endPhase);
		endTurn = new JButton (new ImageIcon("images/EndTurn.png"));
